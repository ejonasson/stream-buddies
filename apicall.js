...
function addStreams(streamNames){
		...
		data="http://www.twitch.tv/widgets/live_embed_player.swf?channel=' + streamNames + '"bgcolor="#000000"> \
		...
		<param name="flashvars" value="hostname=www.twitch.tv&channel=' + streamNames + '&auto_play=false&start_volume=25" /> \
		</object><a href="http://www.twitch.tv/' + streamNames + '" style="padding:2px 0px 4px; display:block \
